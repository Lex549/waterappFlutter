...
fun MessagingTileRendererPreview() {
    ...
    TileLayoutPreview(
        ...
        resourceState = mapOf(
            state.contacts[1] to (context.getDrawable(R.drawable.ali) as
                    BitmapDrawable).bitmap,
            state.contacts[2] to (context.getDrawable(R.drawable.taylor) as
                    BitmapDrawable).bitmap,
        ),
...
private fun contactLayout(
    ...
    .apply{
        if(contact.avatarUrl != null){
            ...
            setButtonColors(
                (ButtonColors.secondaryButtonColors(MessagingTileTheme.colors)))
        }
    }
    .build()